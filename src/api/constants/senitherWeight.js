...
const dungeon_weights = {
  ...
  function calculateSenitherWeight(type, level = null, experience) {
    const slayers = ["revenant", "tarantula", "sven", "enderman", "blaze", "vampire"];
  ...
  function calculateTotalSenitherWeight(profile) {
    ...
    const weight = {
      ...
      slayer: {
        ...
        enderman: calculateSenitherWeight("blaze", null, profile.slayer_bosses?.blaze?.xp || 0),
        enderman: calculateSenitherWeight("vampire", null, profile.slayer_bosses?.vampire?.xp || 0),
      },
      dungeons: {
