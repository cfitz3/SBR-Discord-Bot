...
module.exports = {
    ...
    async execute(interaction) {
        try {
            ...
            const inactivity = JSON.parse(fs.readFileSync("./database/inactivemembers.json", "utf8"));
            ...
            const channel = await interaction.client.channels.fetch(config.staffannouncements);
            if (list.length > 2048) {
